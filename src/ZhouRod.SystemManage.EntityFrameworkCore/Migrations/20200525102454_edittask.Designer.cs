...
namespace ZhouRod.SystemManage.Migrations
{
    ...
    [Migration("20200525102454_edittask")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZhouRod.SystemManage.SystemManage.SM.SMUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ZhouRod.SystemManage.SystemManage.TM.TMPerson", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ZhouRod.SystemManage.SystemManage.TM.TMTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ZhouRod.SystemManage.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ZhouRod.SystemManage.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("ZhouRod.SystemManage.SystemManage.TM.TMTask", b =>
                {
                    b.HasOne("ZhouRod.SystemManage.SystemManage.TM.TMPerson", "AssignedPerson")
                        .WithMany()
