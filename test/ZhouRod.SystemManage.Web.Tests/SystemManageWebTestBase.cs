...
{
    public abstract class SystemManageWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SystemManageWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SystemManageWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SystemManageDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SystemManageDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SystemManageDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SystemManageDbContext, Task<T>> func)
        {
            T result;
